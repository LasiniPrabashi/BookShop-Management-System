...
public class CustomerFormController implements Initializable {
    ...
    public void setCustCount() {
        try {
            txtCustCount.setText(CustomerModel.getCustomerCount());
        } catch (SQLException throwables) {
            throwables.printStackTrace();
        } catch (ClassNotFoundException e) {
            e.printStackTrace();
    ...
    private void setCustomerData(String id) {
        try {
            ...
            tm.setCust_Id(customer.getCust_Id());
            tm.setFistName(customer.getFistName());
            tm.setLastName(customer.getLastName());
            tm.setCity(customer.getCity());
            tm.setContact(customer.getContact());
            ...
            button.setOnAction(actionEvent -> {
                ...
                if (alert.getResult().equals(ButtonType.OK)) {
                    try {
                        if (CustomerModel.remove(customer.getCust_Id())) {
                            loadDataTable();
